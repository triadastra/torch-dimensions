...
|---|---|---|---|---|---|---|---|
| `mamba_upstream_3d` | 50,752 | 0.0061 | 0.0052 | step 50 | 0.085 | 26.5 | 0.054 |
| `lstm_3d` | 51,136 | 0.0082 | 0.0046 | step 36 | 0.371 | 61.8 | 0.077 |
| `lstm_2d_sparse` | 51,136 | 0.7205 | 0.4254 | step 47 | 0.113 | 69.7 | 0.059 |
| `gru_2d_sparse` | 38,464 | 0.7208 | 0.4314 | step 45 | 0.114 | 32.5 | 0.084 |
| `mamba3_2d` | 141,472 | 0.7213 | 0.4304 | step 19 | 0.113 | 13.1 | 0.025 |
| `mamba_portable_2d` | 33,856 | 0.7315 | 0.4421 | step 72 | 0.112 | 43.9 | 0.086 |
| `mamba_upstream_2d` | 33,856 | 0.7324 | 0.4440 | step 71 | 0.110 | 35.9 | 0.086 |
| `s4_upstream_2d` | 17,216 | 0.7336 | 0.4468 | step 85 | 0.115 | 39.5 | 0.151 |
| `s4d_portable_2d` | 13,120 | 0.7356 | 0.4496 | step 86 | 0.117 | 58.4 | 0.204 |
| `s4d_upstream_2d` | 15,168 | 0.7387 | 0.4461 | step 74 | 0.115 | 46.3 | 0.173 |
| `mamba2_2d` | 111,920 | 0.7452 | 0.4538 | step 101 | 0.115 | 5.7 | 0.018 |
| `tcn_2d_sparse` | 25,152 | 1.0556 | 0.7630 | step 55 | 0.065 | 83.4 | 0.099 |
| `transformer_cafa_2d` | 55,376 | 1.4586 | 1.2864 | step 31 | 0.064 | 11.2 | 0.203 |
| `transformer_scan_2d` | 34,112 | 1.6361 | 1.3025 | step 35 | 0.065 | 48.9 | 0.050 |
| `cnn_2d_sparse` | 12,736 | 1.8688 | 1.5487 | step 45 | 0.069 | 98.4 | 0.141 |
| `transformer_flatten_2d` | 34,112 | 2.3187 | 1.9696 | step 47 | 0.073 | 38.0 | 0.022 |
