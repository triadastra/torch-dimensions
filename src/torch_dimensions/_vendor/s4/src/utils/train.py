...
try:  # torch-dimensions patch: training-infrastructure imports; only get_logger below is used by the model modules
    ...
    pl = rich = DictConfig = OmegaConf = None  # torch-dimensions patch

    def rank_zero_only(fn):  # torch-dimensions patch
        return fn  # torch-dimensions patch
