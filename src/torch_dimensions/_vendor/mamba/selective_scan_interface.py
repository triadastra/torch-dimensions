...
from .utils_torch import custom_bwd, custom_fwd  # torch-dimensions patch: vendored path
...
try:  # torch-dimensions patch: triton is optional — only rms_norm_forward below needs it
    from mamba_ssm.ops.triton.layer_norm import _layer_norm_fwd
except ImportError:  # torch-dimensions patch
    _layer_norm_fwd = None  # torch-dimensions patch
...
def selective_scan_fn(u, delta, A, B, C, D=None, z=None, delta_bias=None, delta_softplus=False,
    ...
    """
    if selective_scan_cuda is None:  # torch-dimensions patch: without the CUDA extension,
        # torch-dimensions patch: dispatch to the authors' own pure-torch reference implementation below
        return selective_scan_ref(u, delta, A, B, C, D, z, delta_bias, delta_softplus, return_last_state)  # torch-dimensions patch
