...
try:  # torch-dimensions patch: tensor-parallel training only; unused with process_group=None
...
try:  # torch-dimensions patch: the Hub mixin adds no computation
    ...
    class PyTorchModelHubMixin:  # torch-dimensions patch
        pass  # torch-dimensions patch
